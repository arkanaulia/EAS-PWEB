                ...
                <div class="konten">
                    <div class="row">
                        ...
                        <div class="col-2 text-end">
                            <a href="form-add-student.php" type="button" class="btn btn-primary px-3" style="background-color: #30725E;">
                    ...
                    <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <?php
                                $sql = "SELECT * FROM user WHERE level='Student'";
                                ...
                                while($user = mysqli_fetch_array($query)){
                                    ...
                                    echo "<td>";
                                    echo "<a class='btn btn-primary' href='form-edit-student.php?id=".$user['id']."'>Edit</a> | ";
                                    echo "<a class='btn btn-danger' href='delete-student.php?id=".$user['id']."'>Hapus</a>";
                                    echo "</td>";
